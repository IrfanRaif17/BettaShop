	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				...
				?>
					<a href="produk_penjual.php?kat=<?php echo $k['category_id'] ?>">
						<div class="col-5">
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				...
				?>	
					<a href="detail-produkpenjual.php?id=<?php echo $p['produk_id'] ?>">
						<div class="col-4">
			...
			<div class="box">
				<?php 
					...
					if(mysqli_num_rows($produk) > 0){
						while($p = mysqli_fetch_array($produk)){
				?>	
					<a href="detail-kontespenjual.php?id=<?php echo $p['produk_id'] ?>">
						<div class="col-4">
